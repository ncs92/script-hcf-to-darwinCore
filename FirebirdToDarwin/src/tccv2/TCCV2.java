...
public class TCCV2 {
   ...
   //     System.out.println("\n M3GROUP " + m);
    ...
    public static String selectTabelaHerbario() { //ORDER BY TOMBO.HCF ASC
        String sqlLinha = "SELECT TOMBO.DATA_IDENTIFICACAO, TOMBO.HCF, TOMBO.COMPLEMENTO_COLETOR, ESPECIE.ESPECIE, TIPO.TP_DESCRICAO,"
   ...
   //     System.out.println("\n\n " + coordenada);
    ...
    public static void criarInstancia(ResultSet rs, FileWriter arq) throws IOException, SQLException {
        ...
        if (rs != null) {
            while (rs.next()) {
                ...
                DarwinCore dc = new DarwinCore(dataIdentificacao, codigoBarras, "Br:UTFPR:HCF:" + hcf, hcf, coletor, numColetor,
                        observacao, dataColeta, vegetacao, estado, cidade, altitude, altitude, latitude, longitude, familia,
                        genero, especie, infraspecificEpithet,
                        nomeCientifico, autor, taxon, nomesPopulares, tipo, identificador, dataIdentificacao, identificationQualifier);
        ...
        if (data != null) {
            ...
            if (caracter != null) {
                ...
                if (aux == 3) {
                    ...
                    mes = data.split(caracter)[0];
                    ano = data.split(caracter)[1];
                    mes = converteRomanoToNumber(mes);
                    return ano + "-" + mes;
                }
            } else {
    ...
    public static void main(String[] args) throws Exception {
        FileWriter arq = new FileWriter("C:\\Users\\nani\\Documents\\UTFPR\\TCC\\codigo\\TCC\\darwin.csv");
        try {
            ...
            Connection connection = DriverManager.getConnection(
                    "jdbc:firebirdsql:localhost/3050:C:/databases/herbario.gdb", props);
//             Connection connection = DriverManager.getConnection(
//                    "jdbc:firebirdsql:localhost/3050:C:/Firebird_1.5/databases/herbario.gdb", props);
            ...
            String cabecalho = "basisOfRecord\ttype\tlanguage\tmodified\tinstitutionID\tinstitutionCode\tcollectionCode"
                    ...
                    + "disposition\toccurrenceRemarks\teventDate\thabitat\tcontinent\tcountry\tcountryCode\tstateProvince\t"
